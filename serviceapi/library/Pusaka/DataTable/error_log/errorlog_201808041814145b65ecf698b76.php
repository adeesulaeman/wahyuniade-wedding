SELECT d.Status AS Status,c.NamaSiswa AS Nama,c.NomorInduk AS Nomor,mhs.NimMahasiswa AS Nomor,mhs.NamaMahasiswa AS Nama,e.NamaBeasiswa AS NamaBeasiswa,f.NamaTypePenerima AS NamaTypePenerima,d.Periode AS Periode FROM tbl_pendaftar a
			...
			LEFT JOIN tbl_type_penerima_beasiswa f ON f.IdTypePenerima=d.IdType
			 WHERE 1=1    ORDER BY a.Status DESC LIMIT 0, 25