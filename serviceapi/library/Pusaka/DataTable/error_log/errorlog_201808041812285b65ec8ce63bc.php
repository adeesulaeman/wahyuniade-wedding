SELECT a.StatusPendaftar AS StatusPendaftar,b.NamaSiswa AS Nama,b.NomorInduk AS Nomor,mhs.NimMahasiswa AS Nomor,mhs.NamaMahasiswa AS Nama,e.NamaBeasiswa AS NamaBeasiswa,f.NamaTypePenerima AS NamaTypePenerima,d.Periode AS Periode FROM tbl_pendaftar a
