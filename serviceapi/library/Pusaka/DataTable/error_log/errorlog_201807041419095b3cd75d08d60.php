SELECT a.IdFileBeasiswaH AS IdFileBeasiswaH,a.NamaFileH AS NamaFileH,a.TypeFileH AS TypeFileH,d.NamaFile AS NamaFileUpload,d.CatatanFile AS CatatanFileUpload,IF(d.NamaFile = NULL ? 1 : 0) AS status FROM tbl_file_beasiswa_h a
